 ...
 */
final class Version20250826085021 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contact (id SERIAL NOT NULL, nom_utilisateur VARCHAR(255) DEFAULT NULL, titre VARCHAR(255) NOT NULL, description TEXT NOT NULL, date_envoi TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN contact.date_envoi IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE film (id SERIAL NOT NULL, genre_id INT NOT NULL, titre VARCHAR(255) NOT NULL, synopsis TEXT NOT NULL, age_minimum INT DEFAULT NULL, affiche VARCHAR(255) DEFAULT NULL, coup_de_coeur BOOLEAN NOT NULL, note_moyenne DOUBLE PRECISION DEFAULT NULL, date_publication TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE qualite (id SERIAL NOT NULL, label VARCHAR(255) NOT NULL, prix NUMERIC(6, 2) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE seance (id SERIAL NOT NULL, qualite_id INT NOT NULL, film_id INT NOT NULL, salle_id INT NOT NULL, cinema_id INT NOT NULL, date DATE NOT NULL, heure_debut TIME(0) WITHOUT TIME ZONE NOT NULL, heure_fin TIME(0) WITHOUT TIME ZONE NOT NULL, places_disponible INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_DF7DFD0EA6338570 ON seance (qualite_id)');
        ...
        $this->addSql('CREATE TABLE "user" (id SERIAL NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, forname VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, create_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, reset_password_token VARCHAR(100) DEFAULT NULL, reset_password_expires_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE seance ADD CONSTRAINT FK_DF7DFD0EA6338570 FOREIGN KEY (qualite_id) REFERENCES qualite (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
